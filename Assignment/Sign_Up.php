                    ...
                    <form action="" method="POST">
                        <fieldset>
                            ...
                            <table align="center">
                                ...
                                <tr>
                                <td><input  type="Password" name="Password" placeholder="Enter Your Password" value="<?php echo $password;?>"/>
                                <?php
                                ...
                                <tr>
                                <td><input  type="Password" name="Confirm_Password" placeholder="Re-enter Your Password" value="<?php echo $confirm_password;?>"/>
                                <?php
